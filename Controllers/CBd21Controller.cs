...
{
    public class CBd21Controller : Controller
    {
        private readonly EFCoreDBcontext _context;

        public CBd21Controller(EFCoreDBcontext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index(long id)
        {
            ...
            return View(await _context.CatchBasins.OfType<CBd21>().Where(i => i.ProjId == id).OrderByDescending(d => d.CatchBasinId).ToListAsync());
        }
        ...
        public IActionResult Details(int id)
        {
            ...
            var cb = (from r in _context.CBd21s
                      where r.CatchBasinId == id
        ...
        public async Task<IActionResult> Create([Bind("Description,CBHeight,CBCode,ProjId")] CBd21 c1580CB)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var c1580CB = await _context.CBd21s.FindAsync(id);
            if (c1580CB == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CatchBasinId,Description,CBHeight,CBCode,CBRebFandI,CBRebPurch,ProjId")] CBd21 c1580CB)
        {
        ...
        public async Task<IActionResult> Delete(int? id)
        {
            ...
            var c1580CB = await _context.CBd21s
                .FirstOrDefaultAsync(m => m.CatchBasinId == id);
            if (c1580CB == null)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            _context.CBd21s.Remove(c1580CB);
            await _context.SaveChangesAsync();
        ...
        {
            return _context.CBd21s.Any(e => e.CatchBasinId == id);
        }
        ...
        public IActionResult Results(long id)
        {
            ...
            var CBList =
                from hw in _context.CBd21s.Where(p => p.ProjId == id).OrderBy(i => i.CBCode)
                select hw;
