...
{
    public class CBc1530Controller : Controller
    {
        private readonly EFCoreDBcontext _context;

        public CBc1530Controller(EFCoreDBcontext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Description,CBHeight,CBCode,ProjId,CBc1530Confgs")] CBc1530 cb)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var cb = await _context.CBc1530s.FindAsync(id);
            if (cb == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CatchBasinId,Description,CBHeight,CBCode,CBRebFandI,CBRebPurch,ProjId,CBc1530Confgs")] CBc1530 cb)
        {
        ...
        public async Task<IActionResult> Delete(int? id)
        {
            ...
            var cb = await _context.CBc1530s
        ...
        {
            return _context.CBc1530s.Any(e => e.CatchBasinId == id);
        }
