...
{
    public class CBdetDController : Controller
    {
        private readonly EFCoreDBcontext _context;

        public CBdetDController(EFCoreDBcontext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index(long id)
        {
            ...
            return View(await _context.CatchBasins.OfType<CBdetD>().Where(i => i.ProjId == id).OrderByDescending(d => d.CatchBasinId).ToListAsync());
        }
        ...
        public IActionResult Details(int id)
        {
            ...
            var cb = (from r in _context.cBdetDs
                      where r.CatchBasinId == id
        ...
        public async Task<IActionResult> Create([Bind("Description,CBHeight,CBCode,ProjId")] CBdetD c1580CB)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var c1580CB = await _context.cBdetDs.FindAsync(id);
            if (c1580CB == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CatchBasinId,Description,CBHeight,CBCode,CBRebFandI,CBRebPurch,ProjId")] CBdetD c1580CB)
        {
        ...
        public async Task<IActionResult> Delete(int? id)
        {
            ...
            var c1580CB = await _context.cBdetDs
                .FirstOrDefaultAsync(m => m.CatchBasinId == id);
            if (c1580CB == null)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            _context.cBdetDs.Remove(c1580CB);
            await _context.SaveChangesAsync();
        ...
        {
            return _context.cBdetDs.Any(e => e.CatchBasinId == id);
        }
        ...
        public IActionResult Results(long id)
        {
            ...
            var CBList =
                from hw in _context.cBdetDs.Where(p => p.ProjId == id).OrderBy(i => i.CBCode)
                select hw;
