...
{
    public class CBc1591Controller : Controller
    {
        private readonly EFCoreDBcontext _context;

        public CBc1591Controller(EFCoreDBcontext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Description,CBHeight,CBCode,ProjId,CBCurbType,CBSlottedDrain")] CBc1591 cb)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var cb = await _context.CBc1591s.FindAsync(id);
            if (cb == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CatchBasinId,Description,CBHeight,CBCode,CBRebFandI,CBRebPurch,ProjId,CBCurbType,CBSlottedDrain")] CBc1591 cb)
        {
        ...
        public async Task<IActionResult> Delete(int? id)
        {
            ...
            var cb = await _context.CBc1591s
                .FirstOrDefaultAsync(m => m.CatchBasinId == id);
            if (cb == null)
            {
                return NotFound();
        ...
        {
            return _context.CBc1591s.Any(e => e.CatchBasinId == id);
        }
