...
{
    public class CBp1570Controller : Controller
    {
        private readonly EFCoreDBcontext _context;

        public CBp1570Controller(EFCoreDBcontext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index(long id)
        {
            ...
            return View(await _context.CatchBasins.OfType<CBp1570>().Where(i => i.ProjId == id).OrderByDescending(d => d.CatchBasinId).ToListAsync());
        }
        ...
        public IActionResult Details(int id)
        {
            ...
            var cb = (from r in _context.CBp1570s
                     where r.CatchBasinId == id
        ...
        public async Task<IActionResult> Create([Bind("Description,CBHeight,CBCode,ProjId,CBp1570Typ")] CBp1570 cb)
        {
        ...
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, 
            [Bind("CatchBasinId,Description,CBHeight,CBCode,CBRebFandI,CBRebPurch,ProjId,CBp1570Typ")] CBp1570 cb)
        {
        ...
        public async Task<IActionResult> Delete(int? id)
        {
            ...
            var cb = await _context.CBp1570s
        ...
        {
            return _context.CBp1570s.Any(e => e.CatchBasinId == id);
        }
        ...
        public IActionResult Results(long id)
        {
            ...
            var CBList =
                from hw in _context.CBp1570s.Where(p => p.ProjId == id).OrderBy(i => i.CBCode)
                select hw;
