...
namespace SmallStructuresTakeOffs.Controllers
{
    public class CBp1569_2Controller : Controller
    {
        ...
        public async Task<IActionResult> Index(long id)
        {
            ...
            return View(await _context.CatchBasins.OfType<CBp1569_2>().Where(i => i.ProjId == id).OrderByDescending(d => d.CatchBasinId).ToListAsync());
        }
        ...
        public IActionResult Results(long id)
        {
            ...
            var CBList =
                from hw in _context.CBp1569_2s.Where(p => p.ProjId == id).OrderBy(i => i.CBCode)
                select hw;
